...
data = pd.read_csv("C:\Users\Nirmit\kanoe_project\pop_covered_statewise\AP_pop.csv")
...
ax.set_title('Average rural population covered in AndraPradesh across years(2005-14)')
