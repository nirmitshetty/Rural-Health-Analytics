...
import numpy as np
data = pd.read_csv("C:\Users\Nirmit\kanoe_project\sc_facilities_statewise\WB_fsc.csv")#enter path here
def autolabel(rects):
    for rect in rects:
...
ax.set_title('Sub Centre facilities in WestBengal across years')
