...
import numpy as np
data = pd.read_csv("C:\Users\Nirmit\kanoe_project\o&g_statewise\NAG_og.csv")#enter path here
def autolabel(rects):
    for rect in rects:
...
ax.set_title('Obstetricians & Gynaecologists in Nagaland across years')
