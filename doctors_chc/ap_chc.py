...
import numpy as np
data = pd.read_csv("C:\Users\Nirmit\kanoe_project\doctors_chc\AP_chc.csv")#enter path here
def autolabel(rects):
    for rect in rects:
...
ax.set_title('RSP of doctors at CHCs in Andhra Pradesh across years')
