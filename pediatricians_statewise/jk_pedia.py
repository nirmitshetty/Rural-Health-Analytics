...
import numpy as np
data = pd.read_csv("C:\Users\Nirmit\kanoe_project\pediatricians_statewise\JK_pedia.csv")#enter path here
def autolabel(rects):
    for rect in rects:
...
ax.set_title('Number of pediatricians in JammuKashmir across years')
