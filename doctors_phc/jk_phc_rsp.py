...
import numpy as np
data = pd.read_csv("C:\Users\Nirmit\kanoe_project\doctors_phc\JK_rsp_phc.csv")#enter path here
def autolabel(rects):
    for rect in rects:
...
ax.set_title('Number of doctors in PHC in JammuKahmir across years 2005-14')
