...
import numpy as np
data = pd.read_csv("C:\Users\Nirmit\kanoe_project\doctors_chc\HP_chc.csv")#enter path here
def autolabel(rects):
    for rect in rects:
...
ax.set_title('RSP of doctors at CHCs in Himachal Pradesh across years')
